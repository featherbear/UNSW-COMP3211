...
HD_PWD='D:/Projects/UNSW-COMP3211/labs/test/test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add3.tcl -notrace
